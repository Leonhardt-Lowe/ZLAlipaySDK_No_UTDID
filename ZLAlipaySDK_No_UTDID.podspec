...
Pod::Spec.new do |s|
    ...
    s.resources = ["ZLAlipaySDK_No_UTDID/Classes/iOS_SDK_No_UTDID/AlipaySDK.bundle"]
#    s.public_header_files = "ZLAlipaySDK_No_UTDID/**/*.h"
    s.pod_target_xcconfig = { 'DEFINES_MODULE' => 'YES' }
    s.vendored_frameworks = "ZLAlipaySDK_No_UTDID/Classes/iOS_SDK_No_UTDID/AlipaySDK.framework"
    s.frameworks = 'UIKit','Foundation',"SystemConfiguration","CoreTelephony","QuartzCore","CoreText","CoreGraphics","UIKit","Foundation","CFNetwork","CoreMotion","WebKit"
